...
const JWT_CONFIG = {
    ...
    refreshExpiresIn: 7 * 24 * 60 * 60, // Long-lived refresh token (7 days)
    challengeExpiresIn: 10 * 60,        // 2FA Challenge (10 min)
    wsExpiresIn: 90,                    // Very short-lived WebSocket token (90s)
};
...
// Alias for compatibility (typo in old code)
